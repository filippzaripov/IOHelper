package com.fujitsu.fs.iohelper.impl;
...
public class IOHelperImpl implements IOHelper {
    ...
    public InputStream createInputStream(String source) throws IOException {
       try(InputStream inputStream = new ByteArrayInputStream(source.getBytes())){
           return inputStream;
       }
    ...
    public InputStream createInputStream(String source, String encoding) throws IOException {
      try(InputStream inputStream = new ByteArrayInputStream(source.getBytes(encoding))){
          return inputStream;
      }
